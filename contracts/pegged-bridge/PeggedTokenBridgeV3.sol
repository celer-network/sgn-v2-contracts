...
import "../interfaces/IPeggedTokenV3.sol";
...
contract PeggedTokenBridgeV2 is Pauser, VolumeControl, DelayedTransfer {
    ...
    function mint(
        ...
        if (delayThreshold > 0 && request.amount > delayThreshold) {
            ...
            IPeggedTokenV3(request.token).mint(request.account, request.amount);
        }
    ...
    function burn(
        ...
        IPeggedTokenV3(_token).burn(_amount);
        return burnId;
    }
    ...
    function executeDelayedTransfer(bytes32 id) external whenNotPaused {
        ...
        IPeggedTokenV3(transfer.token).mint(transfer.receiver, transfer.amount);
    }
